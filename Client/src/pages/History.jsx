...
export default function History() {
  ...
  if (isLoading) return <><PageHeader title="History" /><div role="status" aria-label="Loading history" aria-busy="true"><HistorySkeleton /></div></>;

  if (error) {
    return (
      <><PageHeader title="History" /><EmptyState
        icon={HistoryIcon}
