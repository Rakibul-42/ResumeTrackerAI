...
export default function Resumes() {
  ...
  const { data: resumes, isLoading, error } = useResumesList();
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <CardHeader>
              <div>
                ...
                <CardDescription className="mt-1">
                  PDF only, up to 5 MB. Gemini processes the extracted text to create version V1.
                </CardDescription>
              </div>
            </CardHeader>
        ...
        <div className="lg:col-span-7 space-y-3">
          {error && <EmptyState icon={FileText} title="Couldn't load resumes" description={error.message} />}
          {isLoading && (
            <>
