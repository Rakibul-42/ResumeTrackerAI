...
export default function Insights() {
  ...
  if (isLoading) return <><PageHeader title="Insights" /><div role="status" aria-label="Loading insights" aria-busy="true"><InsightsSkeleton /></div></>;

  if (error) {
    return (
      <><PageHeader title="Insights" /><EmptyState
        icon={BarChart3}
