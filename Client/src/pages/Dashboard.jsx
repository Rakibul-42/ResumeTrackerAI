...
export default function Dashboard() {
  return <div className="space-y-6"><PageHeader title="Dashboard" description="Your saved resume activity and estimated scores." /><DashboardContent /></div>;
}
...
function DashboardContent() {
  ...
  if (!totals?.resumes) {
    return (
      <EmptyState
        icon={UploadCloud}
        title="Welcome — start with your resume"
        description="Upload a text-based PDF, then request AI feedback on its structure, wording and keywords. Scores are estimates."
        action={
  ...
  const evolutionDelta = current != null && first != null ? current - first : null;
