...
const FEATURES = [
  {
    ...
    desc: "AI-estimated keyword, formatting, impact and clarity scores.",
  ...
  },
  {
    ...
    desc: "Suggested wording changes for your review, without adding unsupported facts.",
    preview: <RewritePreview />,
  },
  {
    icon: KeyRound,
    title: "Keyword Optimization",
    desc: "Suggests role-relevant keywords based on the target role you provide.",
    preview: <KeywordsPreview />,
  },
  {
    icon: Layers,
    title: "Version History",
    desc: "Save each iteration and analyze the versions you choose.",
  ...
  },
  {
    icon: FileDown,
    title: "PDF Export",
    desc: "Export a saved version using a clean PDF template. Review the result before applying.",
    preview: <PdfPreview />,
  },
  // {
  //   icon: Zap,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, color-mix(in srgb, var(--accent) 18%, transparent) 0%, color-mix(in srgb, var(--accent) 6%, transparent) 35%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
      ...
      <SectionHeader
        ...
        title={
          <>
            ...
            <span
              style={{
                backgroundImage:
                  "linear-gradient(120deg, var(--ink), var(--ink-muted))",
        ...
        sub="Upload, analyze, review, compare and export. Previews below contain illustrative sample data."
      />
            ...
            <div className="relative p-5 sm:p-6">
              <div className="flex items-start gap-3">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, var(--accent-soft) 0%, color-mix(in srgb, var(--brand-cream) 72%, var(--accent-soft)) 100%)",
                    boxShadow:
                      "inset 0 1px 0 0 color-mix(in srgb, var(--brand-cream) 70%, transparent), 0 1px 2px color-mix(in srgb, var(--brand-deep) 6%, transparent)",
                  }}
                >
  ...
  return (
    <div className="rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] p-4">
      <div className="text-[10px] uppercase tracking-wide text-[var(--ink-muted)] font-semibold mb-2">
        Example role: Senior Frontend Engineer
      </div>
