  ...
  return (
    <div className="relative w-full h-[460px] sm:h-[520px]">
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(160deg, var(--brand-brown) 0%, var(--brand-deep) 45%, #160d04 100%)",
          boxShadow:
      ...
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[var(--accent-soft)] text-[var(--accent)] text-[10px] font-semibold">
        ...
        <div className="mt-3 flex items-center justify-center">
          <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-[var(--accent-soft)] text-[var(--accent-strong)] text-[10px] font-semibold tabular">
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(155deg, color-mix(in srgb, var(--brand-brown) 95%, transparent) 0%, color-mix(in srgb, var(--brand-deep) 95%, transparent) 50%, #160d04 100%)",
          boxShadow:
            "0 24px 60px -16px rgba(0,0,0,0.7), inset 0 1px 0 0 rgba(255,255,255,0.05)",
        }}
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="h-6 w-6 rounded-lg bg-[var(--accent-soft)] text-[var(--danger)] flex items-center justify-center">
            <AlertCircle size={12} />
          </div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="h-6 w-6 rounded-lg bg-[var(--accent-soft)] text-[var(--accent-strong)] flex items-center justify-center">
            <Sparkles size={12} />
          </div>
          <div className="text-[11px] font-semibold text-white">AI rewrite</div>
          <div className="ml-auto inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-[var(--accent-soft)] text-[var(--accent-strong)] text-[9px] font-semibold">
        ...
        <div className="flex items-center gap-1.5 my-2 text-white/30">
          <ArrowRight size={11} />
          <span className="text-[9px] uppercase tracking-wide text-[var(--accent-strong)] font-semibold">
            After
          </span>
        </div>
        <div className="text-[11px] text-white leading-snug">
          Developed dashboards for the analytics team.
        </div>
      </motion.div>
