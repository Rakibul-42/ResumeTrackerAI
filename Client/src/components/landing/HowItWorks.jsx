...
function AnalyzeVisual() {
  const items = [
    ...
    { label: "AI review prepared", done: true },
  ...
  return (
    <div className="relative rounded-2xl bg-gradient-to-br from-[var(--surface-2)]/60 to-[var(--surface)] border border-[var(--border)] p-4">
      <div className="flex items-center gap-3">
        ...
        <span aria-hidden="true" className="h-9 w-9 rounded-full bg-[var(--ink)] text-[var(--bg)] flex items-center justify-center shrink-0 transition-transform hover:-translate-y-0.5">
          <FileDown size={13} />
        </span>
      </div>
      <div className="mt-3 pt-3 border-t border-[var(--border)] flex items-center justify-between">
...
const STEPS = [
  {
    ...
    desc: "Create an account and upload a text-based PDF up to 5 MB. Review the AI-processing notice before uploading.",
    Visual: UploadVisual,
  },
  {
    n: "02",
    ...
    desc: "Request an AI-estimated score, issues, strengths and suggested wording for the selected version.",
    Visual: AnalyzeVisual,
  },
  {
    n: "03",
    icon: FileDown,
    title: "Export your selected version",
    desc: "Apply selected rewrites, compare the new version and export a PDF for your own review.",
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        title={<>From upload to a reviewed version in&nbsp;3 steps.</>}
        sub="Upload, request a review, and choose the changes to keep. The previews use sample data."
      />
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* Title */}
                <h3 className="relative lg:min-h-[56px] font-display text-[22px] font-semibold tracking-tight text-[var(--ink)] mt-6 leading-tight">
                  {s.title}
                </h3>

                {/* Description */}
                <p className="relative lg:min-h-[66px] text-[13.5px] text-[var(--ink-muted)] mt-2.5 leading-relaxed">
                  {s.desc}
                </p>
