    ...
    >
      <DarkPanel className="px-6 sm:px-12 lg:px-20 py-16 sm:py-24 text-center">
        ...
        <motion.p
          ...
          className="text-white/85 text-base sm:text-lg mt-5 max-w-xl mx-auto leading-relaxed"
        >
          Upload a text-based PDF, request an AI review, and choose which suggestions to keep. Processing time depends on the document and provider.
        </motion.p>
        ...
        >
          <Link
            to="/register"
            className="group relative inline-flex items-center gap-2 h-12 px-6 rounded-full font-semibold text-[14px] text-[var(--brand-cream)] shadow-[0_10px_30px_-8px_rgba(192,88,0,0.5)] hover:shadow-[0_14px_36px_-8px_rgba(192,88,0,0.7)] active:scale-[0.98] transition-all"
            style={{
              background:
          ...
          >
            ...
            />
            <span className="relative">Create your workspace</span>
        ...
        <motion.div
          ...
          className="mt-6 inline-flex items-center gap-1.5 text-[12px] text-white/85"
        >
          <ShieldCheck size={13} className="text-[var(--brand-orange)]" />
          PDF bytes are not saved; extracted text and results are stored.
        </motion.div>
      </DarkPanel>
    </section>
  );
